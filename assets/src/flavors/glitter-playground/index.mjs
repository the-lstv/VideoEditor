...
class GlitterPlayground extends FlavorBase {
    ...
    static iconSet = {
        icon: 'assets/src/flavors/glitter-playground/images/icon.svg',
        small: 'assets/src/flavors/glitter-playground/images/icon.svg',
        favicon: 'assets/src/flavors/glitter-playground/images/icon.svg',
        // desktopIcon: 'assets/src/flavors/glitter-playground/images/favicon.png'
    };
