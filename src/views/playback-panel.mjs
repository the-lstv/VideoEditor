import * as Visualizers from "../components/audio/visualizers.mjs";
...
export default class PlaybackPanel extends LS.View {
    ...
    constructor() {
        ...
        this.visualizer = new Visualizers.Basic({
            width: 100,
            height: 100,
            renderer: LS.GlobalWebGLRenderer
        });
            ...
            [
                {
                    ...
                    inner: [this.masterGainKnob, this.tempoKnob, this.visualizer]
                },
            ],
